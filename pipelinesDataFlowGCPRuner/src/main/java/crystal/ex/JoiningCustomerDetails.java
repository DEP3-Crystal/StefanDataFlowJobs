...
public class JoiningCustomerDetails {
    ...
    static void performJoin(GcsOptions options) {
        ...
        joined.apply("Joining", ParDo.of(
                ...
                .apply("WriteDataToBigQuery",
                        BigQueryIO.writeTableRows().to("glossy-waters-369414.tq" + options.getTableName())
                                .withCreateDisposition(BigQueryIO.Write.CreateDisposition.CREATE_IF_NEEDED).withWriteDisposition(BigQueryIO.Write.WriteDisposition.WRITE_APPEND).withSchema(FormatSchema.getSchema()));
