...
public class InnerJoin {
    ...
    public static void main(String[] args) {
        ...
        PCollection<KV<String, String>> customersGender = pipeline
                .apply("Read customersGender from file",
                        TextIO.read().from("src/main/resources/source/mall_customers_info.csv"))
                .apply("FilterInfoHeader",
                        ParDo.of(new FilterHeaderFn(CSV_INFO_HEADER)))
                .apply("IdGenderKV",
                        ParDo.of(new IdGenderKVFn()));

        PCollection<KV<String, Integer>> customersScore = pipeline
                .apply("Read customersScore from file", TextIO.read().from("src/main/resources/source/mall_customers_score.csv"))
