...
import static org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position.EARTH_DIAMETER;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertTrue;

import org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position;
import org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.PositionCoder;
...
public class SportTrackerTest {
  ...
  public void testPipeline() throws IOException {
    ...
    PCollection<String> result =
        SportTracker.computeTrackerMetrics(pipeline.apply(asTestStream(input)))
            .apply(
                    ...
                    .via(
                        kv ->
                            String.format(
                                "%s:%d,%d",
                                kv.getKey(),
                                Math.round(kv.getValue().getLength()),
                                kv.getValue().getTime())));
