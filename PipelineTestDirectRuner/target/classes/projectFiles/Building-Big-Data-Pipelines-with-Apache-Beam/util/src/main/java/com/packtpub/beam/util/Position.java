...
public class Position {
  ...
  public static Optional<org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position> parseFrom(String tsv) {
    ...
    return Optional.of(
        new org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position(
            Double.parseDouble(parts[0]), Double.parseDouble(parts[1]), Long.parseLong(parts[2])));
  }

  public static org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position random(long stamp) {
    return new org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position((Math.random() - 0.5) * 180, (Math.random() - 0.5) * 180, stamp);
  }

  public double distance(org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position other) {
    return calculateDistanceOfPositions(this, other);
  }

  public org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position move(
    ...
    return new org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position(
  ...
  private static double calculateDistanceOfPositions(org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position first, org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Position second) {
