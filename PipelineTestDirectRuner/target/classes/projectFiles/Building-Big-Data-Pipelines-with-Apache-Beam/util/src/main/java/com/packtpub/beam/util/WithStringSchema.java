...
public class WithStringSchema extends PTransform<PCollection<String>, PCollection<String>> {
  ...
  public static org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.WithStringSchema of(String field) {
    return new org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.WithStringSchema(field);
  }
