...
public class DebugOutput<T> extends PTransform<PCollection<T>, PCollection<T>> {
  ...
  public static <T> org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.DebugOutput<T> create(String name) {
    return new org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.DebugOutput<>(name);
  }
