...
public class PrintElements<T> extends PTransform<PCollection<T>, PDone> {
  ...
  public static <T> org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.PrintElements<T> of() {
    return new org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.PrintElements<>();
  }
