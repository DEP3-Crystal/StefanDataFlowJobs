...
import static org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Utils.getLines;
import static org.crystal.pipelines.building_big_data_pipelines_with_apache_beam.util.Utils.toWords;

import com.packtpub.beam.chapter3.RPCParDoStateful.Params;
...
public class RPCParDoStatefulTest {
  ...
  public void testRpc() throws IOException {
    ...
    PCollection<KV<String, Integer>> result =
        RPCParDoStateful.applyRpc(
            lines, new Params("", "", "", PORT, 10, Duration.millis(100), new String[] {}));
