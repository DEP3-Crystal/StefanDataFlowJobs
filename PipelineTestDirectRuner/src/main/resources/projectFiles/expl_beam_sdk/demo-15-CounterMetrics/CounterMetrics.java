...
public class CounterMetrics {
    ...
    public static void main(String[] args) {
        ...
        queryAndPrintMetricResults(pipelineResult, "InputRecords", "counter");
        queryAndPrintMetricResults(pipelineResult, "SedanHatchback", "counter");
        queryAndPrintMetricResults(pipelineResult, "PriceThreshold", "counter");
    }
    ...
    private static void queryAndPrintMetricResults(
        ...
        for (MetricResult<Long> counter: metrics.getCounters()) {
            System.out.println("*****" + counter.getName() +
                    ": " + counter.getCommitted() + "/" + counter.getAttempted());
        }
    ...
    private static class FilterHeaderFn extends DoFn<String, String> {
        ...
        private final Counter inputRecordsCounter = Metrics.counter(
                "InputRecords", "counter");
    ...
    private static class FilterSedanHatchbackFn extends DoFn<String, String> {
        ...
        private final Counter sedanHatchbackCounter = Metrics.counter(
                "SedanHatchback", "counter");
    ...
    private static class FilterPriceFn extends DoFn<String, String> {
        ...
        private final Counter priceThresholdCounter = Metrics.counter(
                "PriceThreshold", "counter");
